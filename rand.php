<?	//Purpose:		Generates a pseudorandom string for session id
...
//assigns a number $num to an alphanumeric 
...
//function GetRandID
//generates pseudorandom ID of size $length
